...
dependencies {
    ...
    implementation ("org.springframework.boot:spring-boot-starter-web:2.7.18") // Updated to fix CVE-2024-22243
    
    // Override Spring Framework to 5.3.32 to fix CVE-2024-22243 (open redirect and SSRF vulnerability)
